...
public class Main {
    ...
    private static void tambahLaporan() {
        ...
        for (int i = 0; i < jumlahKendaraan; i++) {
            ...
            kendaraanList.add(new Kendaraan(jenisKendaraan, merk));
        }

        System.out.print("Masukkan jumlah korban: ");
        int jumlahKorban = scanner.nextInt();
        scanner.nextLine();
        List<Korban> korbanList = new ArrayList<>();
        for (int i = 0; i < jumlahKorban; i++) {
            ...
            korbanList.add(new Korban(namaKorban, "-", jenisKelamin, kondisi));
        }

        Kecelakaan kecelakaan = new Kecelakaan(id, jenis, pelapor, lokasi, kendaraanList, korbanList);
